...
while True:
    try:
        os.system('cls || clear')
        tampilkan_header("SELAMAT DATANG DI TOKO ALAT MUSIK")
        ...
        if role_pilihan == "1":
            while True:
                try:
                    os.system('cls || clear')
                    tampilkan_header("MENU USER (Pengguna)")
                    print(f"||{'1.Tampilkan Stock':<{54}}||")
                    print(f"||{'2. Cari Item Berdasarkan Kategori':<{54}}||")
                    print(f"||{'3. Lihat Statistik Stok':<{54}}||")
                    print(f"||{'4. Kembali ke Menu Utama':<{54}}||")
                    print('||' + '_'*54 + '||')
                    print()
            ...
            while True:
                try:
                    ...
                    print(f"||{'6. Lihat Statistik Stok':<{54}}||")
                    print(f"||{'7. Kembali ke Menu Utama':<{54}}||")
                    print('||' + '_'*54 + '||')
                    print()
